...
export default function Floorvana() {
  return (
    <section className="secfinspired py-md-5 py-3 mt-md-5 mt-0">
      <div className="container">
        <div className="row align-items-center">
          <div className="col-md-6">
            <div className="finspired_image">
              <img src="assets/images/floorv_img.png" />
            </div>
          </div>
          <div className="col-md-6">
            <div className="finspired_text">
              <h3 className="h_70 mb-md-3 mb-1">Floorvana+</h3>
              <p>
